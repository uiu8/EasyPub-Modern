...
> ⚠️ **本文档写于 v1.55.0。之后又完成了 v1.55.1（目录获取入口、按钮映射修正、假阳性清理），
> 以及本文件 §4.4 里两处结论的更正（版本号有三个来源、MSBuild 会静默跳过 CoreCompile）。
> 接手请先读 `docs/HANDOFF_v1.55.2.md`，模块与双模式设计看
> `docs/2026-09-15_功能逻辑与双模式设计.md`。**
