...
[![当前版本](https://img.shields.io/badge/当前版本-v0.21.3-2563EB?style=flat-square)](https://github.com/uiu8/EasyPub-Modern/releases/tag/v0.21.3)
...
**[下载最新版](https://github.com/uiu8/EasyPub-Modern/releases/download/v0.21.3/EasyPubModern-v0.21.3-win-x64.zip)** · [查看 Release](https://github.com/uiu8/EasyPub-Modern/releases/tag/v0.21.3)

</div>

![EasyPub Modern v0.21.3 主界面](assets/readme/overview.png)
...
1. 从 [最新版 Release](https://github.com/uiu8/EasyPub-Modern/releases/tag/v0.21.3) 下载并解压 Windows x64 压缩包。
...
- 取消 Calibre 自定义元数据功能，避免 EPUB 与 MOBI 能力不一致造成误解。
- 保留作者、译者、ISBN、出版社、出版日期、分类、语言和简介等标准书籍信息。
- 文件夹元数据映射继续支持按来源目录自动填写标准书籍信息。
...
在“书籍信息 → 文件夹元数据映射”中指定来源目录和出版社、分类、语言等标准信息。以后从该目录导入的书会自动带入对应元数据，也可以逐书覆盖。
...
当前唯一发布版本为 **v0.21.3**。后续 GitHub Release 只保留最新版，首页也只描述当前可下载版本。
